...
mod tests {
    ...
    fn test_to_affine() {
         ...
         let strs0 = ["0x2f0a24d2db4186add71a4962b392c1707ac35162ce4b79ab96e63aa27929e3a2",
                     "0x222d1fb49458000af623370a2485d9584fa7ee60bd31f97f7b7042b4529ea3d9",
                     "0x0172d35c565dffe39c6fb45f63b2744c88e12d28ac2e22d1741d06ca08fabd83"];
         let strs = ["21276626501608936404154099869479701841297826440663668606147220689942697599906",
                     "15458363792295655430130666245190686674930653289003133849107951531821386081241",
                     "655192171857794651156654033148347513265533835288291526635861167222212443523"];
         let out = G1 {
            x: Fq::from_str_vartime(strs[0]).unwrap(),
            y: Fq::from_str_vartime(strs[1]).unwrap(),
            z: Fq::from_str_vartime(strs[2]).unwrap(),
         };

         println!("affine = {:#?}", out.to_affine());
    }
}
